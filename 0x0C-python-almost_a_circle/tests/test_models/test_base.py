#!/usr/bin/python3
"""
    module to use in testing the base class
"""
...
class TestBase(unittest.TestCase):
    """
    class for testing the  case for base class
    """

    def test_basic(self):
        """
        tests basic functionality of the class base
        """
        b = Base()
        b2 = Base()
        b3 = Base()
    ...
    def test_given_id(self):
        """
        to test the id being set when given and not upticking default
        """
        b = Base()
        b2 = Base(24)
        b3 = Base(45)
    ...
    def test_json_method(self):
        """
        to test the Base's to_json_string method
        """
    ...
    def test_write_file_basic(self):
        """
        to test the write to file basic capabilities, given 1 type of class
        """
        s = Square(3, 1, 1, 10)
        s2 = Square(4, 2, 2, 20)
    ...
    def test_write_file_complex(self):
        """
        this tests writing a file with harder inputs
        """
        s = Square(3, 1, 1, 10)
        s2 = Square(4, 2, 2, 20)
        r1 = Rectangle(5, 6, 3, 3, 30)
    ...
    def test_write_file_empty(self):
        """
        to test that am  empty list is written to correct default file
        """
        Base.save_to_file([])
        with open('Rectangle.json', 'r', encoding='utf-8') as myFile:
            text = myFile.read()
    ...
    def test_from_json(self):
        """
        it tests bases from_json_string method to convert string to
    ...
    def test_from_json_empty(self):
        """
        it tests base's from_json_string method with empty inputs
        """
    ...
    def test_read_from_file(self):
        """
        it tests the base class method read from file, for use in
    ...
    def test_read_from_file_basic(self):
        """
        to test that the base class method to read from json files when
            -> input is basic
        """
    ...
    def test_read_from_file_empty(self):
        """
        it tests the base class method to read from json files when
            -> empty
        """
        try:
    ...
    def test_write_csv_basic(self):
        """
        to tests that the base class method to write instances as csv
        """
    ...
    def test_read_csv_basic(self):
        """
        to tests that the base class method to read from csv
            -> basic input
        """
        r1 = Rectangle(10, 7, 2, 8)
        r2 = Rectangle(2, 4)
