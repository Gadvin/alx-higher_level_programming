#!/usr/bin/python3
"""
module to be used as base class
"""
...
class Base:
    """
    the base class for use with other classes
    """
    __nb_objects = 0
    ...
    def to_json_string(list_dictionaries):
        """function that returns JSON string representation of list_dictionaries
        """
    ...
    def from_json_string(json_string):
        """
        function that returns a list of dictionary objects evaluated from json string
        """
    ...
    def to_csv_lines(list_csv):
        """
        function that returns CSV string representation from list of sub class
    ...
    def from_csv_lines(list_csv):
        """
        functionn that returns list of CSV instance objects (containing sub class data)
    ...
    def get_cname_from_sublist(list_objs):
        """
        function that gets proper cname to use when saving objects
        """
        cname = None
    ...
    def save_to_file(cls, list_objs):
        """
        function that saves a list of objects to a file as a JSON string
        """
        new_list = None
    ...
    def create(cls, **dictionary):
        """
        function that creates a new instance of sub class using that class's
    ...
    def load_from_file(cls):
        """
        function that returns a list of all instances in class's file
        """
        cname = cls.__name__
        try:
    ...
    def save_to_file_csv(cls, list_objs):
        """
        function that saves a list of sub-class objects to their file as csv
        """
        list_obj_copy = list_objs.copy()
    ...
    def load_from_file_csv(cls):
        """
        function that loads a list of objects from their csv file
        """
        cname = cls.__name__
        try:
    ...
    def draw(list_rectangles, list_squares):
        """
        function that draws the rectangles and squares using turtle GL
        """
